        ...
        <div className='h-full w-auto px-1'>
            <div className='flex justify-between gap-2'>
                <form onSubmit={handleSearchSubmit} className='w-auto flex items-center justify-between bg-white rounded-full '>
                    ...
                    />
                    <button className='btn btn-circle bg-yellow-400 hover:bg-gray-950'>
                        <FaSearch />
                    </button>
                </form>
                <img
            ...
            {searchUser?.length > 0 ? (
                                ...
                                <div key={user._id}>
                                    <div
                                        ...
                                        className={`flex gap-3 
                                                ...
                                                ${selectedUserId === user?._id ? 'bg-yellow-400' : ''
                                            } `}>
                ...
                <>
                                ...
                                chatUser.map((user, index) => (
                                    <div key={user._id}>
                                        <div
                                            ...
                                            items-center rounded 
                                            p-2 py-1 cursor-pointer
                                            ${selectedUserId === user?._id ? 'bg-yellow-500' : ''
                                            }`}>
                                                {/* socket is online */}
                                            <div className={`avatar ${isOnline[index] ? 'online' : ''}`}>
                                                <div className="w-12 rounded-full">
                    ...
                    <div className='mt-auto px-1 py-1 flex'>
                        <button onClick={handleLogOut} className='hover:bg-yellow-400 w-10 cursor-pointer hover:text-white rounded-lg'>
                            <BiLogOut size={25} />
                        </button>
                        <p className='text-md py-1 text-yellow-300'>Logout</p>
                    </div>
                </>
            )}
        </div>
